...
<div class="container">
    ...
    <?php 
          ...
          ?>
        <div class="col-2 mt-3 mb-3"><a class="btn btn-success" role="button" href="function/getDP.php">Ekspor JSON</a></div>
    </div>
...
<table class="table">
    ...
    <thead>
                ...
                <tbody>
                    ...
                    <td><a href="<?php echo $link="editguna.php?id=$row[no_rm]"?>">Edit</a> | <a href="<?php echo $link="deleteguna.php?id=$row[no_rm]"?>">Delete</a> </td>
